...
const EnvSchema = z.object({
  ...
  ELEVENLABS_VOICE_ID_MS: optionalKey(),
  ELEVENLABS_VOICE_ID_ZH: optionalKey(),
  ELEVENLABS_VOICE_ID_YUE: optionalKey(),
  ...
  OPENAI_MENU_MODEL: z.string().default("gpt-4.1"),
  OPENAI_MENU_LOCALIZATION_MODEL: z.string().default("gpt-5.6"),
  ...
  GOOGLE_CLOUD_TTS_API_KEY: optionalKey(),
  GOOGLE_CANTONESE_VOICE: z.string().default("yue-HK-Standard-A"),
  UNSPLASH_ACCESS_KEY: optionalKey(),
