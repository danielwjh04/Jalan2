...
const styles = StyleSheet.create({
  ...
  narrowLandingCard: { minHeight: 468, flexDirection: 'column-reverse', alignItems: 'stretch', justifyContent: 'center' },
  copy: { flex: 1, gap: spacing(1), zIndex: 1 },
  narrowLandingCopy: { flexGrow: 0, flexShrink: 0, flexBasis: 'auto', minHeight: 176, alignItems: 'center', justifyContent: 'center' },
  eyebrow: { ...eyebrow },
  ...
  narrowLandingStage: { width: 212, height: 216, alignSelf: 'center' },
  haloRing: {
    position: 'absolute',
    width: 112,
    height: 112,
  ...
  narrowLandingHaloRing: { width: 202, height: 202 },
