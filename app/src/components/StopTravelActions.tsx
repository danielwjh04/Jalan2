  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={styles.actions}>
        <Pressable accessibilityRole="link" style={styles.action} onPress={() => void openDirections(stop)}><Ionicons name="navigate-outline" size={17} color={colors.sageDeep} /><Text style={styles.actionText}>Directions</Text></Pressable>
